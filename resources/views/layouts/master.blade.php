...
<head>
    ...
    {{-- @vite(['public/assets/vendor/fontawesome-free/css/all.min.css','public/assets/css/sb-admin-2.min.css']) --}}
...
<body id="page-top">
    ...
    {{-- @vite([
        ...
        'public/assets/js/demo/chart-area-demo.js',
        'public/assets/js/demo/chart-pie-demo.js',
    ]) --}}
