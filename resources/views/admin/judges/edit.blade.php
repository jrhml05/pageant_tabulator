    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card shadow mb-4">
                ...
                <form action="{{  route('judges.update', $data['judge']->id)  }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input name="name" type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" value="{{ $data['judge']->name }}">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input name="email" type="text" class="form-control form-control-lg @error('email') is-invalid @enderror" value="{{ $data['judge']->email }}">
                                @error('email')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
