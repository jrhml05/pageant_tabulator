...
@section('title', 'Rave wear · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Rave wear" route="mr_rave_wear" judge="3" :print="route('mr_pdfrave_wear_judge3')" />
    <x-table-card>
