...
@section('title', 'Rave wear · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Rave wear" route="mr_rave_wear" judge="2" :print="route('mr_pdfrave_wear_judge2')" />
    <x-table-card>
