...
@section('title', 'Pre-pageant · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Pre-pageant" route="mr_prepageant" :print="route('mr_pdfprepageant')" rank="/mr_prepageant_rank" />
    <x-table-card>
        <table class="data-table data-table-ranked">
            <thead>
                <tr>
                    <th scope="col" style="width:15%">Candidate</th>
                    <th scope="col" style="width:15%">Judge 1</th>
                    <th scope="col" style="width:5%">Rank</th>
                    <th scope="col" style="width:15%">Judge 2</th>
                    <th scope="col" style="width:5%">Rank</th>
                    <th scope="col" style="width:15%">Judge 3</th>
                    <th scope="col" style="width:5%">Rank</th>
