...
@section('title', 'Pre-pageant · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Pre-pageant" route="mr_prepageant" judge="3" :print="route('mr_pdfprepageant_judge3')" />
    <x-table-card>
