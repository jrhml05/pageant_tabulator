...
@section('title', 'Pre-pageant · Judge 1 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Pre-pageant" route="mr_prepageant" judge="1" :print="route('mr_pdfprepageant_judge1')" />
    <x-table-card>
