...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - PRE-PAGEANT SCORES (JUDGE 1)</h1>

        <div>

            <a href="{{ route('mr_prepageant_judge1') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 1 Scores</a>

            <a href="{{ route('mr_prepageant_judge2') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 2 Scores</a>

            <a href="{{ route('mr_prepageant_judge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 3 Scores</a>

        </div>

        <div>
            <a href="{{ route('mr_prepageant') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL PREPAGEANT RESULTS</a>
            <a href="{{ route('mr_pdfprepageant_judge1') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
