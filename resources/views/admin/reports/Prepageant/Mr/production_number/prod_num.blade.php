...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - PRODUCTION NUMBER RESULT</h1>

        <div>

            <a href="{{ route('mr_prod_num_judge1') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 1 Production Number Scores</a>

            <a href="{{ route('mr_prod_num_judge2') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 2 Production Number Scores</a>

            <a href="{{ route('mr_prod_num_judge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
        ...
        <div>
            ...
            <a href="javascript:void(0)" onclick="mr_prod_num_rank()" class="d-none d-sm-inline-block btn btn-primary shadow"><i
            ...
            <a href="{{ route('mr_pdfprod_num') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
    ...
    <script>
        ...
        function mr_prod_num_rank()
        {
            alert("production number rank");

            $.ajax({
                type: "GET",
                url: "/mr_prod_num_rank",
                success: function (response) {
                    location.reload();
                },
                error: function ()
                {
                    alert("no production number rank");
                }
            });
        }
