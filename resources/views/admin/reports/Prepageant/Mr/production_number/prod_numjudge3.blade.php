...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - PRODCUTION NUMBER SCORES (JUDGE 3)</h1>
        ...
        <div>
            <a href="{{ route('mr_prod_num') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL PRODUCTION NUMBER RESULTS</a>
            <a href="{{ route('mr_pdfprod_num_judge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
