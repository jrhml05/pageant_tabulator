...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - TALENT SCORES (JUDGE 3)</h1>
        ...
        <div>
            <a href="{{ route('mr_talent') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL TALENT RESULTS</a>
            <a href="{{ route('mr_pdftalent_judge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
