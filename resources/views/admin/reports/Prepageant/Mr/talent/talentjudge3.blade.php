...
@section('title', 'Talent · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Talent" route="mr_talent" judge="3" :print="route('mr_pdftalent_judge3')" />
    <x-table-card>
