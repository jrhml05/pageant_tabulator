...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - TALENT RESULT</h1>

        <div>

            <a href="{{ route('mr_talent_judge1') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 1 Talent Scores</a>

            <a href="{{ route('mr_talent_judge2') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-eye fa-sm text-white-50"></i> JUDGE 2 Talent Scores</a>

            <a href="{{ route('mr_talent_judge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
        ...
        <div>
            ...
            <a href="javascript:void(0)" onclick="mr_talent_rank()" class="d-none d-sm-inline-block btn btn-primary shadow"><i
            ...
            <a href="{{ route('mr_pdftalent') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
