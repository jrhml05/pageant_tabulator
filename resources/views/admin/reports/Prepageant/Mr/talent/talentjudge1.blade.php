...
@section('title', 'Talent · Judge 1 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Talent" route="mr_talent" judge="1" :print="route('mr_pdftalent_judge1')" />
    <x-table-card>
