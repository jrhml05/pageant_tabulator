...
@section('title', 'Talent · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Pre-pageant" title="Talent" route="mr_talent" judge="2" :print="route('mr_pdftalent_judge2')" />
    <x-table-card>
