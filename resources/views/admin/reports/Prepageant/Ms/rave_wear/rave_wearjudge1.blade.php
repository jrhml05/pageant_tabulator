...
@section('title', 'Rave wear · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Rave wear" route="ms_rave_wear" judge="1" :print="route('ms_pdfrave_wear_judge1')" />
    <x-table-card>
