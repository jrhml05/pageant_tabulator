...
@section('title', 'Rave wear · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Rave wear" route="ms_rave_wear" judge="3" :print="route('ms_pdfrave_wear_judge3')" />
    <x-table-card>
