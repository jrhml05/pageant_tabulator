...
@section('title', 'Rave wear · Judge 2 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Rave wear" route="ms_rave_wear" judge="2" :print="route('ms_pdfrave_wear_judge2')" />
    <x-table-card>
