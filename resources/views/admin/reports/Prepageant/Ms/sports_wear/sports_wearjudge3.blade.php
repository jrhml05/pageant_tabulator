...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MS. UEP - SPORTS WEAR SCORES (JUDGE 3)</h1>
        ...
        <div>
            <a href="{{ route('ms_sports_wear') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL SPORTS WEAR RESULTS</a>
            <a href="{{ route('ms_pdfsports_wear_judge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
