...
@section('title', 'Pre-pageant · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Pre-pageant" route="ms_prepageant" judge="1" :print="route('ms_pdfprepageant_judge1')" />
    <x-table-card>
