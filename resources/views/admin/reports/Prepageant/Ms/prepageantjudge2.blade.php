...
@section('title', 'Pre-pageant · Judge 2 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Pre-pageant" route="ms_prepageant" judge="2" :print="route('ms_pdfprepageant_judge2')" />
    <x-table-card>
