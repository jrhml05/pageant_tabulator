...
@section('title', 'Talent · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Talent" route="ms_talent" judge="1" :print="route('ms_pdftalent_judge1')" />
    <x-table-card>
