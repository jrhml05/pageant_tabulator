...
@section('title', 'Talent · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Talent" route="ms_talent" judge="3" :print="route('ms_pdftalent_judge3')" />
    <x-table-card>
