...
@section('title', 'Pre-pageant · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Pre-pageant" title="Pre-pageant" route="ms_prepageant" judge="3" :print="route('ms_pdfprepageant_judge3')" />
    <x-table-card>
