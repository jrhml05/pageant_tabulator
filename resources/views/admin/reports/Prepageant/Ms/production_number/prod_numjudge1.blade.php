...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MS. UEP - PRODCUTION NUMBER SCORES (JUDGE 1)</h1>
        ...
        <div>
            <a href="{{ route('ms_prod_num') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL PRODUCTION NUMBER RESULTS</a>
            <a href="{{ route('ms_pdfprod_num_judge1') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
