...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">SEMI FINALS SCORES J2</h1>
        ...
        <div>
            ...
            <a href="{{ route('pdfsemi_judge2') }}" target="_blank" class="d-none d-sm-inline-block btn btn-primary shadow"><i
