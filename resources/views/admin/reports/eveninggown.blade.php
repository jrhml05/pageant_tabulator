...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">EVENING GOWN SCORES</h1>

        <div>

            <a href="javascript:void(0)" onclick="eveninggownrank()" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-ranking-star fa-sm text-white-50"></i> RANK CANDIDATES</a>

            <a href="{{ route('pdfgown') }}" target="_blank" class="d-none d-sm-inline-block btn btn-primary shadow"><i
    ...
    <script>
        ...
        function eveninggownrank()
        {
            alert("evening gown rank");
