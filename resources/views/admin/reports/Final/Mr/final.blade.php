...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div>
            ...
            <a href="javascript:void(0)" onclick="mr_final_score_seeder()" class="d-none d-sm-inline-block btn btn-primary shadow"><i
    ...
    <script>
        ...
        function mr_final_score_seeder()
        {
            alert("final score seeder");

            $.ajax({
                type: "GET",
                url: "/mr_final_score_seeder",
                success: function (response) {
                    alert(response);
                    location.reload();
                },
