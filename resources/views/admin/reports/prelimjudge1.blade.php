...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">PRELIM SCORES Judge 1</h1>
        ...
        <div>
            ...
            <a href="{{ route('preliminaries') }}" target="_blank" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL PRELIM RESULTS</a>

            <a href="{{ route('pdfprelim_judge1') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
