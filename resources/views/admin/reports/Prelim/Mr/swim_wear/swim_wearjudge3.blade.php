...
@section('title', 'Swim wear · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Swim wear" route="mr_swim_wear" judge="3" :print="route('mr_pdfswim_wearjudge3')" />
    <x-table-card>
