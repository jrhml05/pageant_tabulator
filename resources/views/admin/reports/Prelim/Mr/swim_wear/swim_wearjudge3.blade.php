...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - SWIM WEAR SCORES (JUDGE 3)</h1>
        ...
        <div>
            ...
            <a href="{{ route('mr_pdfswim_wearjudge3') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
