...
@section('title', 'Swim wear · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Swim wear" route="mr_swim_wear" judge="2" :print="route('mr_pdfswim_wearjudge2')" />
    <x-table-card>
