...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MR. UEP - CASUAL WEAR SCORES (JUDGE 5)</h1>
        ...
        <div>
            <a href="{{ route('mr_casual_wear') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL CASUAL WEAR RESULTS</a>
            <a href="{{ route('mr_pdfcasual_wearjudge5') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-print fa-sm text-white-50"></i> PRINT SCORES JUDGE 5</a>
        </div>
