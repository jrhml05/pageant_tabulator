...
@section('title', 'Preliminaries · Judge 1 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Preliminaries" route="mr_prelim" judge="1" :print="route('mr_pdfprelim_judge1')" />
    <x-table-card>
