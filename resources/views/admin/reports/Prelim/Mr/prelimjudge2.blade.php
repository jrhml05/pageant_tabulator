...
@section('title', 'Preliminaries · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Preliminaries" route="mr_prelim" judge="2" :print="route('mr_pdfprelim_judge2')" />
    <x-table-card>
