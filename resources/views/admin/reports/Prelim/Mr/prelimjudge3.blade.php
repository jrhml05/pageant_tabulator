...
@section('title', 'Preliminaries · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Preliminaries" route="mr_prelim" judge="3" :print="route('mr_pdfprelim_judge3')" />
    <x-table-card>
