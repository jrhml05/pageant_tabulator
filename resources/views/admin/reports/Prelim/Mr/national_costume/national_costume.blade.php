...
@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="National costume" route="mr_national_costume" :print="route('mr_pdfnational_costume')" rank="/mr_national_costume_rank" />
