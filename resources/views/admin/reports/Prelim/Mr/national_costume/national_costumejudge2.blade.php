...
@section('title', 'National costume · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="National costume" route="mr_national_costume" judge="2" :print="route('mr_pdfnational_costumejudge2')" />
    <x-table-card>
