...
@section('title', 'National costume · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="National costume" route="mr_national_costume" judge="3" :print="route('mr_pdfnational_costumejudge3')" />
    <x-table-card>
