...
@section('title', 'Formal wear · Judge 1 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Formal wear" route="mr_formal_wear" judge="1" :print="route('mr_pdfformal_wearjudge1')" />
    <x-table-card>
