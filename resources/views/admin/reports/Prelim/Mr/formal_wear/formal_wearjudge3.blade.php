...
@section('title', 'Formal wear · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Formal wear" route="mr_formal_wear" judge="3" :print="route('mr_pdfformal_wearjudge3')" />
    <x-table-card>
