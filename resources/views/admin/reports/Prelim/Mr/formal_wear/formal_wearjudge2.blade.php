...
@section('title', 'Formal wear · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Formal wear" route="mr_formal_wear" judge="2" :print="route('mr_pdfformal_wearjudge2')" />
    <x-table-card>
