...
@section('title', 'Departmental uniform · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Departmental uniform" route="mr_departmental_uniform" judge="3" :print="route('mr_pdfdepartmental_uniformjudge3')" />
    <x-table-card>
