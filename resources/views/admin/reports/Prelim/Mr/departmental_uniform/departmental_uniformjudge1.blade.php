...
@section('title', 'Departmental uniform · Judge 1 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Departmental uniform" route="mr_departmental_uniform" judge="1" :print="route('mr_pdfdepartmental_uniformjudge1')" />
    <x-table-card>
