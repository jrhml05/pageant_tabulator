...
@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Departmental uniform" route="mr_departmental_uniform" :print="route('mr_pdfdepartmental_uniform')" rank="/mr_departmental_uniform_rank" />
