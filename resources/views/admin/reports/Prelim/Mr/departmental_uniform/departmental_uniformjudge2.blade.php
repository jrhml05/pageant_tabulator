...
@section('title', 'Departmental uniform · Judge 2 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Departmental uniform" route="mr_departmental_uniform" judge="2" :print="route('mr_pdfdepartmental_uniformjudge2')" />
    <x-table-card>
