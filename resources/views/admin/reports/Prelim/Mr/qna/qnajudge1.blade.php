...
@section('title', 'Casual Q&A · Judge 1 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Casual Q&A" route="mr_qna" judge="1" :print="route('mr_pdfqnajudge1')" />
    <x-table-card>
