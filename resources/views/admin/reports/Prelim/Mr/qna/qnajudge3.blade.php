...
@section('title', 'Casual Q&A · Judge 3 · Mr. LCUAA')

@section('content')
    <x-report-header division="mr" stage="Preliminaries" title="Casual Q&A" route="mr_qna" judge="3" :print="route('mr_pdfqnajudge3')" />
    <x-table-card>
