...
@section('title', 'Departmental uniform · Judge 2 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Departmental uniform" route="ms_departmental_uniform" judge="2" :print="route('ms_pdfdepartmental_uniformjudge2')" />
    <x-table-card>
