...
@section('title', 'Departmental uniform · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Departmental uniform" route="ms_departmental_uniform" judge="1" :print="route('ms_pdfdepartmental_uniformjudge1')" />
    <x-table-card>
