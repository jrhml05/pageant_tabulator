...
@section('title', 'Swim wear · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Swim wear" route="ms_swim_wear" judge="3" :print="route('ms_pdfswim_wearjudge3')" />
    <x-table-card>
