...
@section('title', 'Swim wear · Judge 2 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Swim wear" route="ms_swim_wear" judge="2" :print="route('ms_pdfswim_wearjudge2')" />
    <x-table-card>
