...
@section('title', 'Swim wear · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Swim wear" route="ms_swim_wear" judge="1" :print="route('ms_pdfswim_wearjudge1')" />
    <x-table-card>
