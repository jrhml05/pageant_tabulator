...
@section('title', 'Preliminaries · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Preliminaries" route="ms_prelim" judge="1" :print="route('ms_pdfprelim_judge1')" />
    <x-table-card>
