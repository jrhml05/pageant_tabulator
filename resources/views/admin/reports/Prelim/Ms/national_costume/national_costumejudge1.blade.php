...
@section('title', 'National costume · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="National costume" route="ms_national_costume" judge="1" :print="route('ms_pdfnational_costumejudge1')" />
    <x-table-card>
