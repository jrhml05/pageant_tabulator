...
@section('title', 'National costume · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="National costume" route="ms_national_costume" judge="3" :print="route('ms_pdfnational_costumejudge3')" />
    <x-table-card>
