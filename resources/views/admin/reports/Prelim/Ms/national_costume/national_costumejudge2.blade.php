...
@section('title', 'National costume · Judge 2 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="National costume" route="ms_national_costume" judge="2" :print="route('ms_pdfnational_costumejudge2')" />
    <x-table-card>
