...
@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="National costume" route="ms_national_costume" :print="route('ms_pdfnational_costume')" rank="/ms_national_costume_rank" />
