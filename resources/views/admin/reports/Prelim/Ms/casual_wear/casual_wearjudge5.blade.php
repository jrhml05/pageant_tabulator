...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">MS. UEP - CASUAL WEAR SCORES (JUDGE 5)</h1>
        ...
        <div>
            ...
            <a href="{{ route('ms_pdfcasual_wearjudge5') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
