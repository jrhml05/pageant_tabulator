...
@section('title', 'Casual Q&A · Judge 2 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Casual Q&A" route="ms_qna" judge="2" :print="route('ms_pdfqnajudge2')" />
    <x-table-card>
