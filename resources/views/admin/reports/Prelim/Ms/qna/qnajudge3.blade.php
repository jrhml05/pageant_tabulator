...
@section('title', 'Casual Q&A · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Casual Q&A" route="ms_qna" judge="3" :print="route('ms_pdfqnajudge3')" />
    <x-table-card>
