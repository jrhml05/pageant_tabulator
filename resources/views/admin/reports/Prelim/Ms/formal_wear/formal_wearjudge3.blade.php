...
@section('title', 'Formal wear · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Formal wear" route="ms_formal_wear" judge="3" :print="route('ms_pdfformal_wearjudge3')" />
    <x-table-card>
