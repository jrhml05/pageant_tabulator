...
@section('title', 'Formal wear · Judge 1 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Formal wear" route="ms_formal_wear" judge="1" :print="route('ms_pdfformal_wearjudge1')" />
    <x-table-card>
