...
@section('title', 'Preliminaries · Judge 3 · Ms. LCUAA')

@section('content')
    <x-report-header division="ms" stage="Preliminaries" title="Preliminaries" route="ms_prelim" judge="3" :print="route('ms_pdfprelim_judge3')" />
    <x-table-card>
