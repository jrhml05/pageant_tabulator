...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">SEMI-FINAL SCORES JUDGE 1</h1>
</div>
...
<table class="table table-bordered">
    <thead class="table-dark">
        <tr>
            ...
            <th style="width:7%">BEAUTY 40%</th>
            <th style="width:7%">POISE 30%</th>
            <th style="width:10%">INTELLIGENCE 30%</th>
            <th style="width:7%">TOTAL 100%</th>
...
<footer>
    <p>UEP CIT/MIS OFFICIAL TABULATOR &commat; MISS BINALONAN 2023 </p>
</footer>
</body>
</html>
