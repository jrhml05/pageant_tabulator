...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">SEMI FINALS SCORES</h1>
        ...
        <div>
            ...
            <a href="javascript:void(0)" onclick="semifinalrank()" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-ranking-star fa-sm text-white-50"></i> RANK CANDIDATES</a>

            <a href="{{ route('pdfsemifinal') }}" target="_blank" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                                            ...
                                            <tr>
                                                ...
                                                @foreach ( $brgy->semifinalscores as $score)
                                                    ...
                                                    @if ($brgy->id == $score->barangay_id && $score->judge_id == 2)
                                                        ...
                                                        @php
                                                            $score_judge1 = $score->beauty + $score->poise + $score->intelligence;
                                                        @endphp
