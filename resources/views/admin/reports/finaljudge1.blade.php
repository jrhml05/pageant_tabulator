...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <h1 class="h3 mb-0 text-gray-800">FINALS SCORES J1</h1>
        ...
        <div>
            ...
            <a href="{{ route('final') }}" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                class="fas fa-less-than fa-sm text-white-50"></i> BACK TO OVERALL FINALS SCORES</a>

            <a href="{{ route('pdffinal_judge1') }}" target="_blank" class="d-none d-sm-inline-block btn btn-primary shadow"><i
                            ...
                            <table class="table table-bordered">
                                <thead class="table-dark">
                                    <tr>
                                        ...
                                        <th style="width:10%">INTELLIGENCE 60%</th>
