...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">PRELIMINARIES RESULT JUDGE 2</h1>
</div>
...
<table class="table table-bordered">
    <thead class="table-dark">
        <tr>
            ...
            <th style="width:10%">BEAUTY</th>
            <th style="width:10%">POISE</th>
            <th style="width:10%">SWIMSUIT</th>
            <th style="width:10%">EVENING GOWN</th>
