<div>
    <div class="mb-6">
        <p class="text-sm font-medium text-ink-2">Mr. LCUAA</p>
    ...
    <nav aria-label="Categories" class="mb-8">
        <ul class="flex flex-wrap gap-2">
            <li><a href="{{ route('judge.app.mr.nationalcostume.score', $stage) }}" class="btn btn-secondary btn-lg">National costume</a></li>
            <li><a href="{{ route('judge.app.mr.departmentaluniform.score', $stage) }}" class="btn btn-secondary btn-lg">Departmental uniform</a></li>
            <li><a href="{{ route('judge.app.mr.swimwear.score', $stage) }}" class="btn btn-secondary btn-lg">Swim wear</a></li>
            <li><a href="{{ route('judge.app.mr.formalwear.score', $stage) }}" class="btn btn-secondary btn-lg">Formal wear</a></li>
            <li><a href="{{ route('judge.app.mr.qna.score', $stage) }}" class="btn btn-secondary btn-lg">Casual Q&A</a></li>
        </ul>
    </nav>
    ...
    <x-judge.grid>
        @foreach ($records as $record)
            ...
            <x-judge.candidate-card division="mr" :record="$record" wire:key="summary-{{ $record->id }}">
