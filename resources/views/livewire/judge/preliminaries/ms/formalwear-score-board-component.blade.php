                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-1">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Elegance 25%</span>
                            </div>
                            <input onfocus="this.select()" wire:model="records.{{ $index }}.elegance" type="number"
                                class="form-control text-center {{ $record->elegance > 25 ? 'is-invalid' : '' }}"
                                placeholder="00.00" aria-describedby="basic-addon1">

                        </div>
                        <div class="input-group mb-1">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Stage Presence 25%</span>
                            </div>
                            <input onfocus="this.select()" wire:model="records.{{ $index }}.presence" type="number"
                                class="form-control text-center {{ $record->presence > 25 ? 'is-invalid' : '' }}"
                                placeholder="00.00" aria-describedby="basic-addon1">

                        </div>
                        <div class="input-group mb-1">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Projection 25%</span>
                            </div>
                            <input onfocus="this.select()" wire:model="records.{{ $index }}.projection" type="number"
                                class="form-control text-center {{ $record->projection > 25 ? 'is-invalid' : '' }}"
                                placeholder="00.00" aria-describedby="basic-addon1">

                        </div>
                        <div class="input-group mb-1">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1">Poise 25%</span>
                            </div>
                            <input onfocus="this.select()" wire:model="records.{{ $index }}.poise" type="number"
                                class="form-control text-center {{ $record->poise > 25 ? 'is-invalid' : '' }}"
                                placeholder="00.00" aria-describedby="basic-addon1">
                        ...
                        <div class="input-group">
                            ...
                            @php
                                $total = ((float) $record->presence) + ((float) $record->elegance) + ((float) $record->projection)+ ((float) $record->poise);
                            @endphp
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><strong>Long Gown Equivalent.</strong>
                                </span>
                            </div>
                            @php
                                $formal_wear = (cal_percentage($total, 100) / 100 ) * 50;
                            @endphp
