<div>
    ...
    <nav aria-label="Categories" class="mb-8">
        <ul class="flex flex-wrap gap-2">
            <li><a href="{{ route('judge.app.mr.ravewear.score', $stage) }}" class="btn btn-secondary btn-lg">Rave wear</a></li>
            <li><a href="{{ route('judge.app.mr.talent.score', $stage) }}" class="btn btn-secondary btn-lg">Talent</a></li>
        </ul>
    </nav>
