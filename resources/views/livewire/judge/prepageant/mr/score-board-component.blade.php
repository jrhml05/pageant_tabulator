                ...
                <div class="card" id="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input disabled wire:model.live="records.{{ $index }}.rave_wear" type="number"
    ...
    <div class="fixed-bottom bg-white">
        <div class="form-group pl-5 pr-5 pt-1">
            ...
            <div class="row mb-1">
                ...
                <div class="col-md-2 mb-1">
                    <a href="{{ route('judge.app.mr.talent.score',$stage) }}" type="button" class="btn btn-info btn-lg btn-block rounded-pill">ENTER TALENT SCORES</a>
