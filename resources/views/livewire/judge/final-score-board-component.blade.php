<div>
    <div class="container mx-auto">
        <div class="flex ...">
            <div class="flex-auto ...">
                <a href="{{ route('judge.app') }}" type="button" class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-600 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:bg-gray-700 mr-2 mb-2">
            ...
            <div class="flex-none ...">
                    ...
                    @if ($score_lock)
                    <button wire:click="alertConfirm(0)" type="button" class="text-white bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 mr-2 mb-2">
                    ...
                    @else
                    <button wire:click="alertConfirm(1)" type="button" class="text-white bg-[#FF9119] hover:bg-[#FF9119]/80 focus:ring-4 focus:outline-none focus:ring-[#FF9119]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:hover:bg-[#FF9119]/80 dark:focus:ring-[#FF9119]/40 mr-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <div
                        ...
                        <a href="#">
                            <img class="rounded-t-lg"
                                src="{{ asset('assets/img/mb/' . $record->barangay_id . '.jpg') }}" alt="" />
                        </a>
                        <div class="p-5">
                            <div class="mb-2">
                                <div class="relative">
                                    ...
                                    @php
                                        if ($record->beauty > 40) {
                                            $validation = 'border-red-500 text-red-500';
                                        } elseif ($record->beauty <= 40 && $record->beauty != null) {
                                            $validation = 'border-green-500 text-green-500 border-3';
                                        } else {
                                            $validation = '';
                                        }

                                        if ($record->intelligence > 60) {
                                            $in_validation = 'border-red-500 text-red-500';
                                        } elseif ($record->intelligence <= 60 && $record->intelligence != null) {
                                            $in_validation = 'border-green-500 text-green-500 border-3';
                                        } else {
                                            $in_validation = '';
                                        }

                                    @endphp
                                    @if ($record->beauty <= 40 && $record->beauty != null)
                                    ...
                                    @endif
                                    <input {{ $record->is_lock ? 'disabled' : '' }} onfocus="this.select()" wire:model.lazy="records.{{ $index }}.beauty"
                                        type="number" id="floating_outlined_beauty_{{ $index }}"
                                        class="{{ $validation }} text-xl text-end block px-2.5 pb-2.5 pt-4 p-4 w-full text-gray-900 border border-gray-300 rounded-lg sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer"
                                        placeholder="0.00" />
                                    <label for="floating_outlined_beauty_{{ $index }}"
                                        class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Beauty
                                        40 %</label>
                                </div>
                            </div>
                            <div class="mb-2">
                                <div class="relative">
                                    @if ($record->intelligence <= 60 && $record->intelligence != null)
                                        <span class="absolute inset-y-0 left-0 flex items-center pl-2">
                                            <button type="submit" class="p-1 focus:outline-none focus:shadow-outline">
                                                <svg fill="none" stroke="currentColor" stroke-linecap="round"
                                                    stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24"
                                    ...
                                    @endif
                                    <input {{ $record->is_lock ? 'disabled' : '' }} onfocus="this.select()"
                                        wire:model.lazy="records.{{ $index }}.intelligence" type="number"
                                        id="floating_outlined_intelligence_{{ $index }}"
                                        class="{{ $in_validation }}  text-xl text-end block px-2.5 pb-2.5 pt-4 p-4 w-full text-gray-900 border border-gray-300 rounded-lg sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer"
                                        placeholder="0.00" />
                                    <label for="floating_outlined_intelligence_{{ $index }}"
                                        class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Intelligence
                                        60 %</label>
                                </div>
                            </div>
                            ...
                            <div class="mb-2">
                                <div class="relative">
                                    ...
                                    <input type="number" disabled
                                        class="text-xl text-end block px-2.5 pb-2.5 pt-4 p-4 w-full text-gray-900 border border-gray-300 rounded-lg sm:text-md focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 peer"
                                        placeholder="0.00" value="{{ number_format($total, 2) }}" />
                                </div>
                            </div>
                        </div>
                    </div>
