...
class MsLcuaaPrePageantReportsController extends Controller
{
    ...
    public function ms_prepageantjudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA Pre-pageant Results Judge 1';
    ...
    public function ms_prepageantjudge2()
    {
        ...
        $data['title'] = 'Ms. LCUAA Pre-pageant Results Judge 2';
    ...
    public function ms_prepageantjudge3()
    {
        ...
        $data['title'] = 'Ms. LCUAA Pre-pageant Results Judge 3';
    ...
    public function ms_rave_wear()
    {
        $data['title'] = 'Ms. LCUAA - Sports Wear Results';
    ...
    public function ms_pdfrave_wear()
    {
        $data['title'] = 'Ms. LCUAA - Sports Wear Results';
        ...
        return $pdf->stream('ms_rave_wear_result.pdf');
    }

    public function ms_rave_wearjudge1()
    {

        $data['title'] = 'Ms. LCUAA - Sports Wear Results (Judge 1)';

        $data['candidate'] = Ms_candidate::all();

        $data['rank'] = Ms_ranking::all();

        return view('admin.reports.prepageant.ms.rave_wear.rave_wearjudge1', compact('data'));
    }

    public function ms_pdfrave_wearjudge1()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prepageant.ms.rave_wear.pdfrave_wearjudge1', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_rave_wear_judge1.pdf');
    }

    public function ms_rave_wearjudge2()
    {

        $data['title'] = 'Ms. LCUAA - Sports Wear Results (Judge 2)';

        $data['candidate'] = Ms_candidate::all();

        $data['rank'] = Ms_ranking::all();

        return view('admin.reports.prepageant.ms.rave_wear.rave_wearjudge2', compact('data'));
    }

    public function ms_pdfrave_wearjudge2()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prepageant.ms.rave_wear.pdfrave_wearjudge2', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_rave_wear_judge2.pdf');
    }

    public function ms_rave_wearjudge3()
    {

        $data['title'] = 'Ms. LCUAA - Sports Wear Results (Judge 3)';

        $data['candidate'] = Ms_candidate::all();

        $data['rank'] = Ms_ranking::all();

        return view('admin.reports.prepageant.ms.rave_wear.rave_wearjudge3', compact('data'));
    }

    public function ms_pdfrave_wearjudge3()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prepageant.ms.rave_wear.pdfrave_wearjudge3', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_rave_wear_judge3.pdf');
    }

    public function ms_talent()
    {
        $data['title'] = 'Ms. LCUAA - Talent Results';
    ...
    public function ms_talentjudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Talent Results (Judge 1)';
    ...
    public function ms_talentjudge2()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Talent Results (Judge 2)';
    ...
    public function ms_talentjudge3()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Talent Results (Judge 3)';
    ...
    public function ms_rave_wear_rank()
    {

        for ($x = 2; $x <= 4; $x++) {
            $score = Ms_ravewear_score::where('judge_id', $x)
        ...
        $get_rank = Ms_ranking::select(DB::raw('SUM(rave_wear) as total'), 'candidate_id')
            ->groupBy('candidate_id')
            ->orderBy('total', 'asc')
            ->get();
