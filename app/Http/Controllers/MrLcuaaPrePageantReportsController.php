...
class MrLcuaaPrePageantReportsController extends Controller
{
    ...
    public function mr_prepageantjudge1()
    {
        ...
        $data['title'] = 'Mr. LCUAA Pre-pageant Results Judge 1';
    ...
    public function mr_prepageantjudge2()
    {
        ...
        $data['title'] = 'Mr. LCUAA Pre-pageant Results Judge 2';
    ...
    public function mr_prepageantjudge3()
    {
        ...
        $data['title'] = 'Mr. LCUAA Pre-pageant Results Judge 3';
    ...
    {
        $data['title'] = 'Mr. LCUAA - Rave Wear Results';
    ...
    public function mr_rave_wearjudge1()
    {
        ...
        $data['title'] = 'Mr. LCUAA - Rave Wear Results (Judge 1)';
    ...
    public function mr_rave_wearjudge2()
    {
        ...
        $data['title'] = 'Mr. LCUAA - Rave Wear Results (Judge 2)';
    ...
    public function mr_rave_wearjudge3()
    {
        ...
        $data['title'] = 'Mr. LCUAA - Rave Wear Results (Judge 3)';
    ...
    {
        $data['title'] = 'Mr. LCUAA - Talent Results';
    ...
    public function mr_talentjudge1()
    {
        ...
        $data['title'] = 'Mr. LCUAA - Talent Results (Judge 1)';
    ...
    public function mr_talentjudge2()
    {
        ...
        $data['title'] = 'Mr. LCUAA - Talent Results (Judge 2)';
    ...
    public function mr_talentjudge3()
    {
        ...
        $data['title'] = 'Mr. LCUAA - Talent Results (Judge 3)';
