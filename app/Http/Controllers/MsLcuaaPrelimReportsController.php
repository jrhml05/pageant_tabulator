...
class MsLcuaaPrelimReportsController extends Controller
{

    public function ms_prelim()
    {
        $data['title'] = 'Ms. LCUAA Preliminaries Results';
    ...
    public function ms_prelimjudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA Preliminaries Results Judge 1';
    ...
    public function ms_prelimjudge2()
    {
        ...
        $data['title'] = 'Ms. LCUAA Preliminaries Results Judge 2';
    ...
    public function ms_prelimjudge3()
    {
        ...
        $data['title'] = 'Ms. LCUAA Preliminaries Results Judge 3';
    ...
    {
        $data['title'] = 'Ms. LCUAA - National Costume Results';
    ...
    public function ms_national_costumejudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA - National Costume Results (Judge 1)';
    ...
    public function ms_national_costumejudge2()
    {
        ...
        $data['title'] = 'Ms. LCUAA - National Costume Results (Judge 2)';
    ...
    public function ms_national_costumejudge3()
    {
        ...
        $data['title'] = 'Ms. LCUAA - National Costume Results (Judge 3)';
    ...
    {
        $data['title'] = 'Ms. LCUAA - Departmental Uniform Results';
    ...
    public function ms_departmental_uniformjudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Departmental Uniform Results (Judge 1)';
    ...
    public function ms_pdfdepartmental_uniformjudge1()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.departmental_uniform.pdfdepartmental_uniformjudge1', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_departmental_uniform_judge1.pdf');
    }

    public function ms_departmental_uniformjudge2()
    {

        $data['title'] = 'Ms. LCUAA - Departmental Uniform Results (Judge 2)';
    ...
    public function ms_pdfdepartmental_uniformjudge2()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.departmental_uniform.pdfdepartmental_uniformjudge2', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_departmental_uniform_judge2.pdf');
    }

    public function ms_departmental_uniformjudge3()
    {

        $data['title'] = 'Ms. LCUAA - Departmental Uniform Results (Judge 3)';
    ...
    public function ms_pdfdepartmental_uniformjudge3()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.departmental_uniform.pdfdepartmental_uniformjudge3', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_departmental_uniform_judge3.pdf');
    }

    public function ms_swim_wear()
    {
        $data['title'] = 'Ms. LCUAA - Swim Wear Results';
    ...
    public function ms_swim_wearjudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Swim Wear Results (Judge 1)';
    ...
    public function ms_pdfswim_wearjudge1()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.swim_wear.pdfswim_wearjudge1', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_swim_wear_judge1.pdf');
    }

    public function ms_swim_wearjudge2()
    {

        $data['title'] = 'Ms. LCUAA - Swim Wear Results (Judge 2)';
    ...
    public function ms_pdfswim_wearjudge2()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.swim_wear.pdfswim_wearjudge2', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_swim_wear_judge2.pdf');
    }

    public function ms_swim_wearjudge3()
    {

        $data['title'] = 'Ms. LCUAA - Swim Wear Results (Judge 3)';
    ...
    public function ms_pdfswim_wearjudge3()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.swim_wear.pdfswim_wearjudge3', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_swim_wear_judge3.pdf');
    }

    public function ms_formal_wear()
    {
        $data['title'] = 'Ms. LCUAA - Formal Wear Results';
    ...
    public function ms_formal_wearjudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Formal Wear Results (Judge 1)';
    ...
    public function ms_formal_wearjudge2()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Formal Wear Results (Judge 2)';
    ...
    public function ms_formal_wearjudge3()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Formal Wear Results (Judge 3)';
    ...
    {
        $data['title'] = 'Ms. LCUAA - Casual Q&A Results';
    ...
    public function ms_qnajudge1()
    {
        ...
        $data['title'] = 'Ms. LCUAA - Casual Q&A Results (Judge 1)';
    ...
    public function ms_pdfqnajudge1()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.qna.pdfqnajudge1', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_qna_judge1.pdf');
    }

    public function ms_qnajudge2()
    {

        $data['title'] = 'Ms. LCUAA - Casual Q&A Results (Judge 2)';
    ...
    public function ms_pdfqnajudge2()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.qna.pdfqnajudge2', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_qna_judge2.pdf');
    }

    public function ms_qnajudge3()
    {

        $data['title'] = 'Ms. LCUAA - Casual Q&A Results (Judge 3)';
    ...
    public function ms_pdfqnajudge3()
    {
        ...
        $pdf = PDF::loadView('admin.reports.prelim.ms.qna.pdfqnajudge3', compact('data'))->setPaper(array(0, 0, 612, 936), 'landscape');

        return $pdf->stream('ms_qna_judge3.pdf');
    }
    ...
    {
        $data['title'] = 'MS. LCUAA Top 5 Results';
