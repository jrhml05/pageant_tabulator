...
class ProdnumScoreBoardComponent extends Component
{
    ...
    {
        $this->records = Ms_prodnum_score::where('judge_id', Auth::user()->id)
            ->orderBy('candidate_id', 'ASC')
            ->get();
    }
    public function render()
    {
        return view('livewire.judge.prepageant.ms.prodnum-score-board-component');
    }
    ...
    public function save()
    {
        foreach ($this->records as $record) {
            ...
            Ms_prodnum_score::updateOrCreate(
                [
                    'id' => $record->id,
