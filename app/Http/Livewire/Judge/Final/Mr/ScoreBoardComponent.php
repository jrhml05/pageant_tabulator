...
namespace App\Http\Livewire\Judge\Final\Mr;
...
class ScoreBoardComponent extends Component
{
    ...
    {
        return view('livewire.judge.final.mr.score-board-component');
    }

    public function mount()
    {
        $this->records = Mr_final_score::where('judge_id', Auth::user()->id)
    ...
    public function confirmedLockInScores()
    {
        ...
        if($locked == 1){
            return redirect()->route('judge.app.mr.final.score', $this->stage);
        }
